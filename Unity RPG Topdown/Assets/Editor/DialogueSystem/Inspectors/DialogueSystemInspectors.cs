...
namespace DialogueSystem.Inspectors
{
    ...
    public class DialogueSystemInspector : Editor
    {
        ...
        private void DrawDialogueGroupArea(DialogueSystemDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            int olDialogueSystemelectedDialogueGroupIndex = selectedDialogueGroupIndexProperty.intValue;
            ...
            UpdateIndexOnNamesListUpdate(dialogueGroupNames, selectedDialogueGroupIndexProperty, olDialogueSystemelectedDialogueGroupIndex, oldDialogueGroupName, isOldDialogueGroupNull);
            ...
            DialogueSystemDialogueGroupSO selectedDialogueGroup = IOUtilities.LoadAsset<DialogueSystemDialogueGroupSO>($"Assets/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
        ...
        private void DrawDialogueArea(List<string> dialogueNames, string dialogueFolderPath)
        {
            ...
            int olDialogueSystemelectedDialogueIndex = selectedDialogueIndexProperty.intValue;
          ...
          //  UpdateIndexOnNamesListUpdate(dialogueNames, selectedDialogueIndexProperty, olDialogueSystemelectedDialogueIndex, oldDialogueName, isOldDialogueNull);
            ...
            DialogueSystemDialogueSO selectedDialogue = IOUtilities.LoadAsset<DialogueSystemDialogueSO>(dialogueFolderPath, selectedDialogueName);
        ...
        private void UpdateIndexOnNamesListUpdate(List<string> optionNames, SerializedProperty indexProperty, int olDialogueSystemelectedPropertyIndex, string oldPropertyName, bool isOldPropertyNull)
        {
            ...
            bool oldIndexIsOutOfBounDialogueSystemOfNamesListCount = olDialogueSystemelectedPropertyIndex > optionNames.Count - 1;
            bool oldNameIsDifferentThanSelectedName = oldIndexIsOutOfBounDialogueSystemOfNamesListCount || oldPropertyName != optionNames[olDialogueSystemelectedPropertyIndex];
